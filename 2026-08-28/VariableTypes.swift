...
let accountNumberLastFour = String(accountNumber.suffix(4))
let maskedAccount = "****\(accountNumberLastFour)"
...
let summary: String = "\(transactionCount) transactions averaging \(String(format: "%.2f", averageTransaction)) each"
print(summary)
...
if let parsedAmount = parsedAmount {
...
print("Credit rating: \(creditScore)")
